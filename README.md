...
## Current Navigation Architecture (Updated)

The project now uses:
- `src/layouts/Layout.astro` global wrapper
- `src/components/Header.astro` (desktop navigation + utility actions)
- `src/components/MobileMenu.astro` (mobile slide-in)
- `src/data/menu.js` (data-driven menu tree)

Legacy components removed: `Navbar.astro`, `NavigationBar.astro`, `BaseLayout.astro`, old `navigation/MobileMenu.astro`.

Update menu entries by editing `src/data/menu.js`.
